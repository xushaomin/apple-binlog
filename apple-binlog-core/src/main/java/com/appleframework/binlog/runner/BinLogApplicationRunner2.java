...
@Component("applicationRunner2")
public class BinLogApplicationRunner2 implements ApplicationRunner {

    private static final Logger logger = LoggerFactory.getLogger(BinLogApplicationRunner2.class);
    ...
    private void initBinaryLogStatus() {
        logger.info("init binary log status,fileName={},position={}",
            BinaryLogConfig.getBinlogFilename(),
            BinaryLogConfig.getBinlogPosition());
